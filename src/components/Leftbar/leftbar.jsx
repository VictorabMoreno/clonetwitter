    ...
    return(
        <>
          <Bar className='flex-col'>
              ...
              <Link to='/explore/foryou'><Display className = "items-center flex"><Shadowback><BiSearch /><p>Explore</p></Shadowback></Display></Link>
              <Link to='/notification'><Display className = "items-center flex"><Shadowback><BiBell /><p>Notificações</p></Shadowback></Display></Link>
              <Link to='/messages'><Display className = "items-center flex"><Shadowback><MdEmail /><p>Mensagens</p></Shadowback></Display></Link>
              <Link to='/books'><Display className = "items-center flex"><Shadowback><BsFillBookmarkFill /><p>Bookmarks</p></Shadowback></Display></Link>
              <Link to='/lists'><Display className = "items-center flex"><Shadowback><RiPagesFill /><p>Listas</p></Shadowback></Display></Link>
              <Link to='/profile'><Display className = "items-center flex"><Shadowback><BsPersonFill /><p>Perfil</p></Shadowback></Display></Link>
